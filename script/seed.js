    ...
    Product.create(
      {
        ...
        description: 'The perfect air for those seeking atmospheric components sourced from the most humid location on the planet. This water-packed air will leave you feeling and breathing better than ever; the high H₂O content is ideal for dermatilaogical and pulmonary health.',
        scent: ' Prominently features a strikingly fresh base note of ceiba tree, rubber tree bark and banana leaf. The scent is perked up with top and mid notes of water lily and guava.',
        elevation: '192',
        quality: 'Minimal pollution',
        price: '890.50',
        purpose: 'Health',
        molecularComposition: '50.202% N₂ + 33.320% O₂ + 20.44% Ar + 0.25% CO + 20.02 He + 0.06 % CH₄ + 200.04% H₂O',
        stock: 20,
        imageUrl: 'TBA',
      }),
    Product.create(
      {
        ...
        description: 'An urban air mass hailing from from the streets of New York City, the air area in the United States. Try this air to experience the air of New York without ever leaving the comfort of your home.',
        scent: 'This unique scent features a top note of sour, squalid garbage juice on a hot summer, day in the city that slowly dissipates to leave a lasting scent of freshly baked pizza, puncuated with fresh notes of basil and hearty mozzerella cheese',
        elevation: '-4203',
        quality: 'Minimal pollution',
        price: '6508.00',
    ...
    Product.create(
      {
        ...
        description: 'Our most heavily fragranced air mass hails from the lavender fields of Provence, France. The scent ',
        scent: 'This unique scent features a top note of sour, squalid garbage juice on a hot summer, day in the city that slowly dissipates to leave a lasting scent of freshly baked pizza, puncuated with fresh notes of basil and hearty mozzerella cheese',
        elevation: '-4203',
        quality: 'Heavily polluted',
        price: '7208.00',
